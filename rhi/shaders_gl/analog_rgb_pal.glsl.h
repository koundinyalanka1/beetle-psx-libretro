...
#ifndef GL_ANALOG_RGB_PAL_GLSL_H
#define GL_ANALOG_RGB_PAL_GLSL_H
...
static const char *analog_rgb_pal_glsl =
   "#version 330 core\n"
   "#define PAL 1\n"
   "\n"
   ...
   "			vec2((px + 0.5) / reg_src_size.x, row), 0.0).rgb;\n"
   "	}\n"
   "\n"
...
static const char *analog_rgb_pal_glsl_ES =
   "#version 300 es\n"
   "precision highp float;\n"
   "precision highp int;\n"
   "#define PAL 1\n"
...
#endif /* GL_ANALOG_RGB_PAL_GLSL_H */
