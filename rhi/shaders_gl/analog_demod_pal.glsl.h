...
#ifndef GL_ANALOG_DEMOD_PAL_GLSL_H
#define GL_ANALOG_DEMOD_PAL_GLSL_H
...
static const char *analog_demod_pal_glsl =
   "#version 330 core\n"
   "#define PAL 1\n"
   "\n"
   ...
   "{\n"
   "	highp float k = clamp(x, 0.0, reg_sig_size.x - 1.0);\n"
   "	return textureLod(uComb, vec2((k + 0.5) / reg_sig_size.x, row), 0.0).xy;\n"
   "}\n"
   "\n"
   "void main()\n"
   "{\n"
   ...
   "		highp float ph = an_phase(k, line, reg_x1, reg_inv_ratio,\n"
...
static const char *analog_demod_pal_glsl_ES =
   "#version 300 es\n"
   "precision highp float;\n"
   "precision highp int;\n"
   "#define PAL 1\n"
...
#endif /* GL_ANALOG_DEMOD_PAL_GLSL_H */
