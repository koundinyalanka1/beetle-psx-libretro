...
"$GLSLC" -o prebuilt/msaa_resolve_weighted.comp.inc -mfmt=c -DHDR16 msaa_resolve_weighted.comp
"$GLSLC" -o prebuilt/msaa_resolve_weighted.sdr.comp.inc -mfmt=c msaa_resolve_weighted.comp
...
"$GLSLC" -o prebuilt/analog.rgb.frag.inc -mfmt=c analog_rgb.frag
"$GLSLC" -o prebuilt/analog.rgb.pal.frag.inc -mfmt=c -DPAL analog_rgb.frag
